...
type TableAlicloudEcsDiskMetricWriteIopsHourlyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableAlicloudEcsDiskMetricWriteIopsHourlyGenerator{}

func (x *TableAlicloudEcsDiskMetricWriteIopsHourlyGenerator) GetTableName() string {
	return "alicloud_ecs_disk_metric_write_iops_hourly"
}

func (x *TableAlicloudEcsDiskMetricWriteIopsHourlyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableAlicloudEcsDiskMetricWriteIopsHourlyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableAlicloudEcsDiskMetricWriteIopsHourlyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableAlicloudEcsDiskMetricWriteIopsHourlyGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {

			data := task.ParentRawResult.(ecs.Instance)
			_, err := listCMMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "HOURLY", "acs_ecs_dashboard", "DiskWriteIOPS", "instanceId", data.InstanceId)
...
func (x *TableAlicloudEcsDiskMetricWriteIopsHourlyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return alicloud_client.BuildRegionList()
}

func (x *TableAlicloudEcsDiskMetricWriteIopsHourlyGenerator) GetColumns() []*schema.Column {
...
func (x *TableAlicloudEcsDiskMetricWriteIopsHourlyGenerator) GetSubTables() []*schema.Table {
	return nil
}
